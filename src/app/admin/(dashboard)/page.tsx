...
const invoiceEvents: Record<number, { id: string; client: string; amount: number; type: "vps" | "shared" | "dedicated" | "domain"; status: "due" | "overdue" }[]> = {
...
function KPICard({ icon: Icon, label, value, delta, up, sub, iconColor, iconBg }: {
    icon: React.ElementType; label: string; value: string; delta: string; up: boolean; sub: string; iconColor: string; iconBg: string;
}) {
    return (
                    ...
                    <div style={{ position: "relative" }}>
                        <ResponsiveContainer width="100%" height={150}>
                            <PieChart>
                                ...
                                <Tooltip formatter={(v: any, n: any) => [`${v}%`, n]} contentStyle={{ background: "#fff", border: "1px solid #EAECF0", borderRadius: 10, fontSize: 12 }} />
                            </PieChart>
                        </ResponsiveContainer>
